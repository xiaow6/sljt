...
const zh: Record<string, string> = {
  ...
  "trait.temporal_echo": "时序回放",
  "trait.temporal_echo.desc": "回合结束时,以 50% 伤害再次释放本回合的攻击。",
  "trait.silicon_regen": "硅基重整",
  "trait.silicon_regen.desc": "回合开始时,获得固定数量的格挡。",
  "trait.biomech_regen": "共生再生",
  "trait.biomech_regen.desc": "回合开始时,治疗自身 HP。",
  "trait.void_drain": "虚空蚕食",
  "trait.void_drain.desc": "回合开始时,从你身上抽走 1 点充能。",
  "trait.spore_burst": "孢子爆裂",
  "trait.spore_burst.desc": "死亡时,对玩家施加易伤。",
  "trait.runic_mark": "符文标记",
  "trait.runic_mark.desc": "玩家回合开始时,对玩家施加 1 层易伤。",
...
const en: Record<string, string> = {
  ...
  "trait.temporal_echo": "Temporal Echo",
  "trait.temporal_echo.desc": "At end of its turn, replays this turn's attack at 50% damage.",
  "trait.silicon_regen": "Silicon Reform",
  "trait.silicon_regen.desc": "Gains a fixed amount of block at the start of each of its turns.",
  "trait.biomech_regen": "Biomech Regen",
  "trait.biomech_regen.desc": "Heals HP at the start of each of its turns.",
  "trait.void_drain": "Void Drain",
  "trait.void_drain.desc": "At the start of its turn, drains 1 Charge from the player.",
  "trait.spore_burst": "Spore Burst",
  "trait.spore_burst.desc": "When this enemy dies, the player gains Vulnerable.",
  "trait.runic_mark": "Runic Mark",
  "trait.runic_mark.desc": "At the start of every player turn, applies 1 Vulnerable to the player.",
